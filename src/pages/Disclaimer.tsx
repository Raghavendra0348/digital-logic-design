          ...
          <div className="glass-strong p-8 rounded-xl space-y-6 text-foreground/90">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                The information provided on Logic Glow (logicglow.lovable.app) is for general educational and informational purposes only. All content, including but not limited to text, graphics, images, simulations, and interactive tools, is provided "as is" without any warranty of any kind, either express or implied.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-2 ml-4 mt-3">
                <li><strong>Email:</strong> <a href="mailto:contact@logicglow.com" className="text-accent underline">contact@logicglow.com</a></li>
                <li><strong>Website:</strong> <a href="https://logicglow.lovable.app/contact" className="text-accent underline">logicglow.lovable.app/contact</a></li>
              </ul>
            </section>
          </div>
        </motion.div>
